...
\NormalTok{NTL.chem <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv"}\NormalTok{)}
\NormalTok{NTL.litter <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Processed/NEON_NIWO_Litter_mass_trap_Processed.csv"}\NormalTok{)}
...
\begin{Highlighting}[]
\CommentTok{#3}
\NormalTok{lake_temperatures_july <-}
\StringTok{  }\NormalTok{NTL.chem }\OperatorTok{%>%}
...
\CommentTok{#4}
\NormalTok{Temp_AIC <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ lake_temperatures_july, temperature_C }\OperatorTok{~}\StringTok{ }\NormalTok{year4 }\OperatorTok{+}\StringTok{ }\NormalTok{daynum }\OperatorTok{+}\StringTok{ }\NormalTok{depth)}
...
\begin{Highlighting}[]
\CommentTok{#6}
\NormalTok{Temp_ancova_interaction <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ NTL.chem, temperature_C }\OperatorTok{~}\StringTok{ }\NormalTok{lakename }\OperatorTok{*}\StringTok{ }\NormalTok{depth)}
\KeywordTok{summary}\NormalTok{(Temp_ancova_interaction)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#8}
\NormalTok{temp_plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(lake_temperatures_july, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ depth, }\DataTypeTok{y =}\NormalTok{ temperature_C, }\DataTypeTok{color =}\NormalTok{ lakename)) }\OperatorTok{+}
...
\StringTok{  }\CommentTok{#scale_color_viridis_d() +}
...
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.spacing.x =} \KeywordTok{unit}\NormalTok{(}\DecValTok{0}\NormalTok{, }\StringTok{"cm"}\NormalTok{))}

\KeywordTok{print}\NormalTok{(temp_plot)}
\end{Highlighting}
\end{Shaded}
