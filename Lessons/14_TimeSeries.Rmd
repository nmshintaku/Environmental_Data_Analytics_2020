...
#gets rid of NAs in only in the discharge mean column
...
#taking daily data (365 days in a year) from column 8, time series does not preserve your dates 
```
...
#boxes is showing relative size of y axis data to each other
#seasonal + trend = data and remainder is left over data that doesn't fit into seasonal or trend
#seasonal is extracted from the 365 days and represents a repeated cycle 
...
> Mean daily discharge in the Eno River from 1927-1971 was significantly higher than mean daily discharge from 1985-2019 (Wilcoxon test, W = , p-value < 0.00001)

> Represent graphically: Boxplot, density plot, violin plot
...
> aggregation: Putting data together; bundling data to create a bigger dataset, such as daily to yearly; fill in msissing data gap by aggregating daily to monthly 

> subsampling: only looking at sections of your data

> interpolation: if you have gaps, you can generate points to fill in the gaps 
...
#no significant trend over time bc p-value is 0.88 (not less than 0.05)
...
> There is no significant trend with discharge over time in the Eno River (Seasonal Mann-Kendall, z = -0.13967, p-value = 0.8889). 
