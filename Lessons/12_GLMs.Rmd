...
#for every 1m depth change, there is a -95.89 irradiance. at a depth of 0, there is an irradiance of 486
#31% of our irradiance is explained by depth (adjusted r-squared)
...
> Irradiance decreases significantly with decreasing depth (linear regression, R2 = 0.31, df = 15449, p < 0.0001)
...
#one unit increase in depth, a change in log value of irradiance is -0.74
...
#alpha would be depth = 0 and DO = 0 
...
#can't compare AIC to other Lm models 
