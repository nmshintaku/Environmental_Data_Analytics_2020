...
print(O3plot7)  
#hjust 1 is on the right side, hjust -1 is on the left side
# * in subscript means you are finished with your subscript
```
...
NvsP2 <-
  ...
  labs(x = expression("TP"~(mu/L)), y = expression("TN"~(mu/L)), color = "Depth (m)", shape = "") +  
  scale_shape_manual(values = c(15, 17)) +
  scale_color_distiller(palette = "Blues", direction = 1) +
  #scale_color_brewer() # use scale_color_brewer for discrete variables
...
# change labels for nutrients in the legend --> use scale color discrete
...
Nutrientplot <-
  ...
  geom_boxplot() +
  labs(x = "", y = expression(paste("Concentration (", mu, "g/L)")), color = "Nutrients") +
